...
\[
\begin{split}
 \underset{t\to \infty }{\mathop{\lim }}\,{{c}^{(t)}}=&\underset{t\to \infty }{\mathop{\lim }}\,\sum\limits_{l=1}^{u}{r_{ijcl}^{(t)}\lambda _{cl}^{(t)}} \\ 
 =& \underset{t\to \infty }{\mathop{\lim }}\,\sum\limits_{l=1}^{u}{[\eta r_{ijcl}^{(t-1)}+(1-\eta )r_{ij}^{(t-1)}]\lambda _{cl}^{(t-1)}(1-}\eta ) \\ 
 &   \vdots  \\ 
 =& \underset{t\to \infty }{\mathop{\lim }}\,\left\{ {{\eta }^{t}}{{(1-\eta )}^{t}}\sum\limits_{l=1}^{u}{r_{ijcl}^{(0)}\lambda _{cl}^{(0)}+}{{(1-\eta )}^{t+1}}(r_{ij}^{(t-1)}+\eta r_{ij}^{(t-2)} \right \\
& \left +\cdots +{{\eta }^{t-1}}r_{ij}^{(0)})\sum\limits_{l=1}^{u}{\lambda _{cl}^{(0)}} \right\}  \\ 
 =& \text{0} \\ 
\end{split}
\]
